...
const struct flag_type room_flags[] =
{
    ...
    {	"hanger",		ROOM_HANGER,		TRUE	},
    {	"regen",		ROOM_REGEN,		TRUE	},
    {	"",			0,			0	}
};
...
const struct flag_type extra_flags[] =
{
    ...
    {	"no_locate",		ITEM_NO_LOCATE,		TRUE	},
    {	"unique",		ITEM_UNIQUE,		TRUE	},
    {	"astral",		ITEM_ASTRAL,		TRUE	},
    {	"noloot",		ITEM_NOLOOT,		TRUE	},
    {	"hardened",		ITEM_HARDENED,		TRUE	},
    {	"",			0,			0	}
};
...
const struct flag_type act_flags[] =
{
    ...
    {	"flat_level",		ACT_FLAT_LEVEL,		TRUE	},
    ...
    {	"valheru",		ACT_VALHERU,		TRUE	},
    {	"cithdeux",		ACT_CITHDEUX,		TRUE	},
    {	"syndicate",		ACT_SYNDICATE,		TRUE	},
    {	"brotherhood",		ACT_BROTHERHOOD,	TRUE	},
    {	"exodus",		ACT_EXODUS,		TRUE	},
    {	"mercenary",		ACT_MERCENARY,		TRUE	},
    {   "no_ranged",		ACT_NO_RANGED,		TRUE	},
    {   "finish",		ACT_FINISH,		TRUE	},
    {	"",			0,			0	}
};
